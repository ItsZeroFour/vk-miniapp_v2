            ...
            <div className="game-content">
              ...
              <div className="wrapper-container">
                <Routes>
                  ...
                  />
                  <Route
                    path="/menu/hub/game1/game"
                    element={<FaceRecognition />}
                  />
                  <Route
                    path="/menu/hub/game1/final"
                    element={<FaceRecognitionFinal finalUserId={finalUserId} />}
                  />

                  {/* ТОЧКИ КОНТАКТА */}
                  <Route path="/menu/hub/game2" element={<ContactDots />} />
                  <Route
                    path="/menu/hub/game2/game"
                    element={<ContactDotsGame />}
                  />
                  <Route
                    path="/menu/hub/game2/end"
                    element={<ContactDotsEnd finalUserId={finalUserId} />}
                  />

                  {/* СВОЙ-ЧУЖОЙ */}
                  <Route path="/menu/hub/game3" element={<FriendOrFoe />} />
                  <Route
                    path="/menu/hub/game3/start"
                    element={<FriendOrFoeGame />}
                  />
                  <Route
                    path="/menu/hub/game3/end"
